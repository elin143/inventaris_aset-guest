    ...
    <body>
        ...
        <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container text-center py-5">
                <h1 class="display-4 text-dark mb-4 animated slideInDown">Tambah Lokasi</h1>
            </div>
        </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card shadow-lg border-0 rounded-4">
                            <div class="card-header bg-primary text-white text-center py-3 rounded-top-4">
                                <h4 class="mb-0">Form Tambah Data Lokasi</h4>
                            </div>
                                ...
                                <form action="{{ route('lokasi.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="keterangan" class="form-control" rows="3" placeholder="Masukkan keterangan lokasi" required></textarea>
                                        </div>

                                        <div class="col-md-12 mb-3">
                                            <label class="form-label fw-bold">Lokasi Text</label>
                                            <textarea name="lokasi_text" class="form-control" rows="3" placeholder="Masukkan deskripsi lokasi"></textarea>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label fw-bold">Foto / Denah Lokasi</label>
