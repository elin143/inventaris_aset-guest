                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-lg border-0 rounded-4">
                        <div class="card-header bg-primary text-white text-center py-3 rounded-top-4">
                            <h4 class="mb-0">Form Tambah Data Pemeliharaan Aset</h4>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="pelaksana" class="form-control"
                                            placeholder="Nama teknisi / pihak terkait" required>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="tindakan" class="form-control" rows="3"
                                            placeholder="Contoh: Servis rutin, penggantian suku cadang"
                                            required></textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label fw-bold">
                                            Bukti Pemeliharaan (Foto / Dokumen)
                                        </label>
