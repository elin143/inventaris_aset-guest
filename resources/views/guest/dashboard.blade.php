...
<head>
    ...
    <!-- CSS here -->
    <link type="text/css" href="{{ asset('assets-guest/css/bootstrap.min.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/owl.carousel.min.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/slicknav.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/flaticon.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/animate.min.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/magnific-popup.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/fontawesome-all.min.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/themify-icons.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/slick.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/nice-select.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('assets-guest/css/style.css') }}"rel="stylesheet">
...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{ asset('assets-guest/img/logo/loder.jpg') }}" alt="logo">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                    <a href="index.html"><img src="{{ asset('assets-guest/img/logo/logo.png') }}"
                                            alt="logo"></a>
                                </div>
                            </div>
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li class="add-list"><a href="listing_details.html"><i class="ti-plus"></i>
                                                    add Listing</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('assets-guest/img/gallery/location2.png') }}"alt="location">
                            </div>
                            <div class="location-details">
                                <p>Paris</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src=" {{ asset('assets-guest/img/gallery/location3.png') }}"alt="location">
                            </div>
                            <div class="location-details">
                                <p>Rome</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('assets-guest/img/gallery/location5.png') }}" alt="location">
                            </div>
                            <div class="location-details">
                                <p>Nepal</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="" {{ asset('assets-guest/img/gallery/location6.png') }}"
                                    alt="location">
                            </div>
                            <div class="location-details">
                                <p>indonesia</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
                            ...
                            <img class="shape1 d-none d-lg-block"
                                src="{{ asset('assets-guest/img/icon/serices1.png') }}" alt="icon">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-8">
                            <div class="visit-caption">
                                ...
                                <p>Unlike what its name implies, dry cleaning is not actually a 'dry' process. Clothes
                                    are soaked in a different solvent.</p>
                                ...
                                <div class="visit-categories mb-40">
                                    ...
                                    <div class="visit-cap">
                                        ...
                                        <p>Unlike what its name implies, dry cleaning is not actu process. Clothes
                                            soaked differentent.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="testimonial-caption ">
                                    <div class="testimonial-top-cap">
                                        <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                                            ...
                                            viverra maecenas accumsan lacus vel facilisis por incididunt ut labore et
                                            dolore mas. </p>
                                    </div>
                                    <!-- founder -->
                                    <div
                                        ...
                                        <div class="founder-img">
                                            <img
                                                src=" {{ asset('assets-guest/img/testmonial/Homepage_testi.png') }}"alt="testi">
                                        </div>
                            ...
                            <div class="single-testimonial text-center">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div
                                        class="testimonial-founder d-flex align-items-center justify-content-center mb-30">
                                        <div class="founder-img">
                                            <img src="{{ asset('assets-guest/img/testmonial/Homepage_testi.png') }}"
                                                alt="testi">
                                        </div>
                                        <div class="founder-text">
                                            <span>Oliva jems</span>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src=" {{ asset('assets-guest/img/gallery/home_blog1.png') }}"alt="galeri">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src=" {{ asset('assets-guest/img/gallery/home_blog2.png') }}"alt="home">
                            </div>
                            <div class="team-caption">
                                <span>HEALTH & CARE</span>
                                <h3><a href="blog.html">The Best SPA Salons For
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src=" {{ asset('assets-guest/img/gallery/home_blog3.png') }}"alt="galeri">
                            </div>
                            <div class="team-caption">
                                <span>HEALTH & CARE</span>
                                <h3><a href="blog.html">The Best SPA Salons For
                                ...
                                <div class="single-footer-caption mb-30">
                                    ...
                                    <div class="footer-logo">
                                        <a href="index.html"><img
                                                src="{{ asset('assets-guest/img/logo/logo2_footer.png') }}"
                                                alt="footer"></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="footer-tittle">
                                    ...
                                    <ul>
                                        <li class="app-log"><a href="#"><img
                                                    src=" {{ asset('assets-guest/img/gallery/app-logo.png') }}"alt="logo"></a>
                                        </li>
                                        <li><a href="#"><img
                                                    src="{{ asset('assets-guest/img/gallery/app-logo2.png') }}"
                                                    alt="app logo"></a></li>
                                    </ul>
                                </div>
                            </div>
    ...
    <!-- JS here -->
    <script src="{{ asset('assets-guest/js/vendor/modernizr-3.5.0.min.js') }}"></script>
    ...
    <script src="{{ asset('assets-guest/js/jquery.slicknav.min.js') }}"></script>
    ...
    <script src="{{ asset('assets-guest/js/animated.headline.js') }}"></script>
    <script src="{{ asset('assets-guest/js/jquery.magnific-popup.js') }}"></script>
    <script src="{{ asset('assets-guest/js/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('assets-guest/js/jquery.sticky.js') }}"></script>
    <script src="{{ asset('assets-guest/js/contact.js') }}"></script>
    <script src="{{ asset('assets-guest/js/jquery.form.js') }}"></script>
    <script src="{{ asset('assets-guest/js/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('assets-guest/js/mail-script.js') }}"></script>
